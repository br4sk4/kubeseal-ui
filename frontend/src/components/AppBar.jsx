import {Box, Flex, Heading, HStack, Image, Spacer, Text, useColorMode} from "@hope-ui/solid"
...
function AppBar() {
    ...
    const colorModeIcon = createMemo(() => colorMode() === "dark" ? <FiMoon /> : <FiSun />)
    ...
    return (
        <Box height="60px" width="100vw" minWidth="1394px">
            <Flex bg="$primary" css={{ paddingTop: "5px", paddingBottom: "5px", paddingLeft: "10px", paddingRight: "10px" }}>
                ...
                <Spacer />
                <Box p="$1" color="white" paddingTop="6px">
                    <FormButton width="40px" height="40px" icon={colorModeIcon} onClick={toggleColorMode} />
                </Box>
            </Flex>
        </Box>
    )
